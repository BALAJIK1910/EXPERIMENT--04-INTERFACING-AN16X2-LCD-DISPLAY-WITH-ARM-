...
int main(void)
{
  ...
  Lcd_PortType ports[] = { GPIOA, GPIOA, GPIOA, GPIOA };
    	...
    	Lcd_cursor(&lcd,0,1);
   Lcd_string(&lcd, "BALAJI KAMARAJ\n");
   Lcd_cursor(&lcd,1,1);
    Lcd_string(&lcd, "212224040043");
  /* Infinite loop */
...
<img width="1918" height="1197" alt="Screenshot 2026-05-15 160148" src="https://github.com/user-attachments/assets/e9102a77-3005-481c-bc67-0dc065553ef0" />


 
 ## CIRCUIT DIAGRAM (EXPORT THE GRAPHICS TO PDF AND ADD THE SCREEN SHOT HERE): 
 [EXP 4 PMC LAYOUT.pdf](https://github.com/user-attachments/files/27797947/EXP.4.PMC.LAYOUT.pdf)
